...
class TestMerge(unittest.TestCase):
    ...
    def test_merge_states(self):
        ...
        self.assertEqual(len(result[u'objects'][u'states']), 2)
        self.assertEqual(result[u'objects'][u'states']
                         [u'type'], u'GeometryCollection')
        self.assertEqual(len(result[u'objects'][u'states'][u'geometries']), 2)
        self.assertEqual(result[u'objects'][u'states']
                         [u'geometries'][0][u'type'], u'Polygon')
    ...
    def test_merge_counties(self):
        ...
        data[u"objects"][u"ac-counties"][u"geometries"].append(
            {u"type": u"Polygon", u"properties": {}})

        result = merge.merge(data)

        self.assertEqual(len(result[u'objects'][u'counties']), 2)
        self.assertEqual(result[u'objects'][u'counties']
                         [u'type'], u'GeometryCollection')
        self.assertEqual(
            len(result[u'objects'][u'counties'][u'geometries']), 1)
